...
public class ClientController{
    ...
    public ResponseEntity<DataResponse> GetAll(Authentication auth){
		...
		try{
			...
			List<ClientModel> data= service.GetAll(authModel);
    ...
    public ResponseEntity<FilterDataResponse> Filter(@Valid @RequestBody FilterDataRequest object,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            List<ClientModel> data= service.Filter(object,authModel);
    ...
    public ResponseEntity<DataResponse> GetByID(@Valid  @PathVariable("id") String id,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            ClientModel data= service.GetByID(id,authModel);
             response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
        }catch(Exception e){
             response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
        }
    ...
    @PostMapping("/Add")
     public ResponseEntity<DataResponse> Add( @RequestBody ClientModel object,Authentication auth){
         DataResponse response=new DataResponse();
         try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            ClientModel data= service.Add(object,authModel);
             response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
         }catch(Exception e){
             response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
         }
    ...
    public ResponseEntity<DataResponse> Delete(@Valid  @PathVariable("id") String id,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            ClientModel data= service.Delete(id,authModel);
            response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
        }catch(Exception e){
           response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
        }
    ...
    public ResponseEntity<DataResponse> Update(@Valid  @PathVariable("id") String id,@Valid  @RequestBody ClientModel object,Authentication auth){
        DataResponse response=new DataResponse();
       try{
        AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
        ClientModel data= service.Update(id,object,authModel);
            response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
       }catch(Exception e){
            response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
       }
