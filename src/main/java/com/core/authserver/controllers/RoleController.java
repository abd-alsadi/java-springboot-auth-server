...
public class RoleController{
    ...
    public ResponseEntity<DataResponse> GetAll(Authentication auth){
		...
		try{
			...
			List<RoleModel> data= service.GetAll(authModel);
    ...
    public ResponseEntity<FilterDataResponse> Filter(@Valid @RequestBody FilterDataRequest object,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            List<RoleModel> data= service.Filter(object,authModel);
    ...
    public ResponseEntity<DataResponse> GetByID(@Valid  @PathVariable("id") String id,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            RoleModel data= service.GetByID(id,authModel);
             response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
        }catch(Exception e){
             response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
        }
    ...
    @PostMapping("/Add")
     public ResponseEntity<DataResponse> Add( @RequestBody RoleModel object,Authentication auth){
         DataResponse response=new DataResponse();
         try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            RoleModel data= service.Add(object,authModel);
             response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
         }catch(Exception e){
             response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
         }
    ...
    public ResponseEntity<DataResponse> Delete(@Valid  @PathVariable("id") String id,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            RoleModel data= service.Delete(id,authModel);
            response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
        }catch(Exception e){
           response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
        }
    ...
    public ResponseEntity<DataResponse> Update(@Valid  @PathVariable("id") String id,@Valid  @RequestBody RoleModel object,Authentication auth){
        DataResponse response=new DataResponse();
       try{
        AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
        RoleModel data= service.Update(id,object,authModel);
            response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
       }catch(Exception e){
            response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
       }
