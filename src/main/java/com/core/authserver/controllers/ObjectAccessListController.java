...
@RestController
@RequestMapping("api/ObjectAccessList")
@RequiredArgsConstructor
public class ObjectAccessListController{

    @Autowired
    private ObjectAccessListService service;
    ...
    public ResponseEntity<DataResponse> GetAll(Authentication auth){
		...
		try{
			...
			List<ObjectAccessListModel> data= service.GetAll(authModel);
    ...
    public ResponseEntity<FilterDataResponse> Filter(@Valid @RequestBody FilterDataRequest object,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            List<ObjectAccessListModel> data= service.Filter(object,authModel);
    ...
    public ResponseEntity<DataResponse> GetByID(@Valid  @PathVariable("id") String id,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            ObjectAccessListModel data= service.GetByID(id,authModel);
             response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
        }catch(Exception e){
             response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
        }
    ...
    @PostMapping("/Add")
     public ResponseEntity<DataResponse> Add( @RequestBody ObjectAccessListModel object,Authentication auth){
         DataResponse response=new DataResponse();
         try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            ObjectAccessListModel data= service.Add(object,authModel);
             response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
         }catch(Exception e){
             response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
         }
    ...
    public ResponseEntity<DataResponse> Delete(@Valid  @PathVariable("id") String id,Authentication auth){
        ...
        try{
            AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
            ObjectAccessListModel data= service.Delete(id,authModel);
            response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
        }catch(Exception e){
           response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
        }
    ...
    public ResponseEntity<DataResponse> Update(@Valid  @PathVariable("id") String id,@Valid  @RequestBody ObjectAccessListModel object,Authentication auth){
        DataResponse response=new DataResponse();
       try{
        AuthunticationModel authModel = AuthHelper.getAuthunticationUser(auth);
        ObjectAccessListModel data= service.Update(id,object,authModel);
            response = new DataResponse(null, data, ModConstant.StatusCode.SUCCESS);
       }catch(Exception e){
            response = new DataResponse(e.getMessage(), null, ModConstant.StatusCode.ERROR);
       }
